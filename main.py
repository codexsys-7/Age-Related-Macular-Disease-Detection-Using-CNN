...
path_to_model = r'A:/TechieYan projects/AI/EYE_ARMD/model/weights_best_val_96_255.hdf5'
...
def save_file():
    ...
    def stream(label):
        for image in imagee.iter_data():
            ...
            frame_image = ImageTk.PhotoImage(Image.fromarray(img_half))
    ...
    if np.argmax(prediction) == 0:
        print("YES")
        messagebox.showinfo("Result","The person is having Dry ARMD in his/her eyes.")
    elif np.argmax(prediction) == 1:
        print("YES")
        messagebox.showinfo("Result","The person is having Wet ARMD in his/her eyes.")
    else:
        print("NO")
        messagebox.showinfo("Result","The person's Eyes are Normal.")



v_d = Label(root,text="Age Related Macular Degeneration using CNN", font=("Times New Roman",30), bd=8, relief=SUNKEN)
